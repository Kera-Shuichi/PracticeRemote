<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Practice2.aspx.cs" Inherits="Pr25_DataBind.Practice2" %>
...
<body>
    ...
    商品一覧
    <%-- OnPageIndexChanging="GridView1_PageIndexChanging"：ページャーが変更されたときのイベント作成
      AllowPaging="True" ：ページャーを表示する設定
    --%>
    <asp:GridView ID="GridView1" runat="server" Height="16px" Width="895px" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" ShowHeaderWhenEmpty="True" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="True" OnRowCommand="GridView1_RowCommand">
      ...
      <Columns>
        ...
        <asp:ButtonField ButtonType="Button" CommandName="NextPage" Text="遷移">
